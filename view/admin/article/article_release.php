            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body am-fr">
                        ...
                        <form class="am-form tpl-form-border-form tpl-form-border-br" action="index.php?r=adminArticle/saveArticle&a_id=<?=$article['a_id']?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" value="<?=$article['a_id']?>" name="a_id">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="user-name" value="<?=$article['a_title'];?>" name="a_title" placeholder="请输入标题文字">
							...
							<div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                     <input type="text" class="tpl-form-input" id="user-name" value="<?=$article['a_uname'];?>" name="a_uname" placeholder="作者" readonly="true" >
                                    <small>作者为必填</small>
                                </div>
                            </div>
							...
							<div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                     <input type="text" class="tpl-form-input" id="user-name" value="<?=$article['a_begin_text'];?>" name="a_begin_text" placeholder="文章简介" >
                                    <small>文章简介为必填</small>
                                </div>
                            </div>
                           <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="am-form-field tpl-form-no-bg" value="<?=$article['a_date'];?>" name="a_date" placeholder="发布时间" readonly="true">
                                    <small>发布时间为必填</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="10" id="user-intro" placeholder="请输入文章内容"  name="a_content"><?=$article['a_content'];?></textarea>
                                </div>
                            </div>
